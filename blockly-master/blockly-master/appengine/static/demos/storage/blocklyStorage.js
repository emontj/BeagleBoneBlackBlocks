...
/**
 * Sends workspace to cloud storage to be stored.
 * We get back a link to the saved workspace.
 * @param url where the data will be sent
 * @param data workspace data
 * @returns {Promise<Response>}
 */
BlocklyStorage.sendWorkspace = async function(url, data){
